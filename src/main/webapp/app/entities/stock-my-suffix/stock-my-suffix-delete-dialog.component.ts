...
export class StockMySuffixDeleteDialogComponent {
    ...
    constructor(private stockService: StockMySuffixService, public activeModal: NgbActiveModal, private eventManager: JhiEventManager) {}
...
export class StockMySuffixDeletePopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ stock }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(StockMySuffixDeleteDialogComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
