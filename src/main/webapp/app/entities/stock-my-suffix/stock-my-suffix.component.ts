...
export class StockMySuffixComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.stockService
            ...
            .subscribe(
                (res: HttpResponse<IStockMySuffix[]>) => this.paginateStocks(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/stock-my-suffix'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateStocks(data: IStockMySuffix[], headers: HttpHeaders) {
