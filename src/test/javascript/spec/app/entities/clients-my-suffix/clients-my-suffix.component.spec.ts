...
import { ClientsMySuffixComponent } from 'app/entities/clients-my-suffix/clients-my-suffix.component';
...
describe('Component Tests', () => {
    describe('ClientsMySuffix Management Component', () => {
        let comp: ClientsMySuffixComponent;
        let fixture: ComponentFixture<ClientsMySuffixComponent>;
        let service: ClientsMySuffixService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [LpaecommsTestModule],
                declarations: [ClientsMySuffixComponent],
                providers: [
                    {
                ...
                .overrideTemplate(ClientsMySuffixComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(ClientsMySuffixComponent);
